...
if (isset($_POST['TitreEventExt'], $_POST['dateEventExt'], $_POST['adresse'], $_POST['ville'], $_POST['cp'],$_POST['ValiderCreationEventExt'])) {
    ...
    if (isset($_POST['upload'])) {
        ...
        if ($handle->uploaded) {
            ...
            if ($handle->processed) {
                ...
                $returnInsertion = $eventToCreate->insertNewEvent($titre, $date, $adresse, $ville, $cp);
